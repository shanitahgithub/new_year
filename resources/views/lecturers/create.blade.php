...
<div class="container">
    ...
    <form action="{{ route('lecturers.store') }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="supervised_students" id="supervised_students" class="form-control" value="{{ old('supervised_students') }}">
        </div>

        <div class="mb-3">
            <label for="social_links" class="form-label">Social Links</label>
            <input type="text" name="social_links" id="social_links" class="form-control" value="{{ old('social_links') }}">
        </div>

        <div class="mb-3">
            <label for="office_hours" class="form-label">Office Hours</label>
            <input type="text" name="office_hours" id="office_hours" class="form-control" value="{{ old('office_hours') }}">
        </div>
