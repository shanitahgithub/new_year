...
<head>
    ...
    <style>
        ...
        .main button:hover {
            background-color: #5e0000; /* Darker Maroon */
        }
...
.col-md-6 {
    flex: 1 1 45%; /* Allow both columns to take up equal space */
    padding: 10px;
}
...
@keyframes slideBackground {
    0% { background-image: url('https://witi.ac.ug/wp-content/uploads/2023/09/CLF_9627-scaled.jpg'); }
    33% { background-image: url('https://pbs.twimg.com/media/Ga0M-33bwAAMWb2?format=jpg&name=4096x4096'); }
    ...
    66% { background-image: url('https://pbs.twimg.com/media/Ga0M-33bwAAMWb2?format=jpg&name=4096x4096'); }
    100% { background-image: url('https://witi.ac.ug/wp-content/uploads/2023/09/CLF_9627-scaled.jpg'); }
...
/* Styling the content */
.main h1, .main button {
    position: relative; /* Make text appear above the overlay */
    z-index: 2;
}
...
<body>
    ...
    <div class="footer">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="social-icons">
                        ...
                        <a href="https://www.linkedin.com/company/witu/posts?lipi=urn%3Ali%3Apage%3Ad_flagship3_search_srp_all%3B2P%2F6simATMmm%2BJGKdxQYWA%3D%3D"><i class="fab fa-facebook-f"></i></a>
            ...
            <h6 ><marquee>All copyrights reserved 2024</marquee></h6>
        </div>
    </div>
